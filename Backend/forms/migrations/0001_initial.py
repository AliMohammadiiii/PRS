    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [
                    models.Index(fields=['team', 'version_number'], name='forms_formtem_team_id_idx'),
                    models.Index(fields=['team', 'is_active'], name='forms_formtem_team_id_2_idx'),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [
                    models.Index(fields=['template', 'field_id'], name='forms_formfie_templat_idx'),
                    models.Index(fields=['template', 'order'], name='forms_formfie_templat_2_idx'),
                ],
            },
        ),
    ]
